...
export default function NewsPreview(props) {
  ...
  return (
    <div>
        {
        newsInfo && <div className={style['site-page-header-ghost-wrapper'] }>
           <PageHeader
            ghost={false}
      ...
      >   
             ...
             <Descriptions.Item label="创建时间">{moment(newsInfo?.createTime).format("YYY/MMM/DD HH-mm:ss")}</Descriptions.Item>
